	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				StrangerthinMod.LOGGER.warn("Failed to load dependency world for procedure Stop!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				StrangerthinMod.LOGGER.warn("Failed to load dependency x for procedure Stop!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				StrangerthinMod.LOGGER.warn("Failed to load dependency y for procedure Stop!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				StrangerthinMod.LOGGER.warn("Failed to load dependency z for procedure Stop!");
			return;
		}
