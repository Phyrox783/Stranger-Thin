...
public class NevercassetteItem extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:nevercassette")
	public static final Item block = null;

	public NevercassetteItem(StrangerthinModElements instance) {
		super(instance, 61);
	}
