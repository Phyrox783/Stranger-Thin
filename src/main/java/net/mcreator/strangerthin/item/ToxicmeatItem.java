...
public class ToxicmeatItem extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:toxicmeat")
	public static final Item block = null;

	public ToxicmeatItem(StrangerthinModElements instance) {
		super(instance, 65);
	}
