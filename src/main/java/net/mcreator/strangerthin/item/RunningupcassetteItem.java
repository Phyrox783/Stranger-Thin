...
public class RunningupcassetteItem extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:runningupcassette")
	public static final Item block = null;

	public RunningupcassetteItem(StrangerthinModElements instance) {
		super(instance, 58);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("runningupcassette");
		}
