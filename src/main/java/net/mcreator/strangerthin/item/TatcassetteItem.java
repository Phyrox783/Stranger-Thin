...
public class TatcassetteItem extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:tatcassette")
	public static final Item block = null;

	public TatcassetteItem(StrangerthinModElements instance) {
		super(instance, 57);
	}
