...
public class MastercassetteItem extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:mastercassette")
	public static final Item block = null;

	public MastercassetteItem(StrangerthinModElements instance) {
		super(instance, 60);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("mastercassette");
		}
