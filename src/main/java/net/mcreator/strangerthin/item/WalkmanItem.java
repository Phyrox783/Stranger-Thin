...
import net.mcreator.strangerthin.gui.WalkmanguiGuiWindow;
import net.mcreator.strangerthin.gui.WalkmanguiGui;
...
public class WalkmanItem extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:walkman")
	public static final Item block = null;

	public WalkmanItem(StrangerthinModElements instance) {
		super(instance, 54);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof WalkmanguiGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Walkman");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new WalkmanguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
