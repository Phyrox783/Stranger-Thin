...
public class MaterialcassetteItem extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:materialcassette")
	public static final Item block = null;

	public MaterialcassetteItem(StrangerthinModElements instance) {
		super(instance, 62);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("materialcassette");
		}
