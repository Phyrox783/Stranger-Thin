...
public class UpsidedirtBlock extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:upsidedirt")
	public static final Block block = null;

	public UpsidedirtBlock(StrangerthinModElements instance) {
		super(instance, 52);
	}
