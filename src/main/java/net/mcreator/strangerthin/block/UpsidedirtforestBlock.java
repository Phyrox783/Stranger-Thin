...
public class UpsidedirtforestBlock extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:upsidedirtforest")
	public static final Block block = null;

	public UpsidedirtforestBlock(StrangerthinModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("upsidedirtforest");
		}
