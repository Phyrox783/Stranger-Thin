...
import net.mcreator.strangerthin.block.UpsidedirtBlock;
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-6710887).setWaterColor(-3750188).setWaterFogColor(-3750188)
						...
						.setAmbientSound(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("strangerthin:ammibance")))
						.build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(UpsidedowndirtBlock.block.getDefaultState(),
								UpsidedirtBlock.block.getDefaultState(), UpsidedirtBlock.block.getDefaultState())));
