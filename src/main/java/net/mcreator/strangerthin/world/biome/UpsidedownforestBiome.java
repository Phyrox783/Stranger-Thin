...
import net.mcreator.strangerthin.block.UpsidedirtforestBlock;
...
public class UpsidedownforestBiome extends StrangerthinModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-6710887).setWaterColor(-10066330).setWaterFogColor(-10066330)
						.withSkyColor(-6710887).withFoliageColor(-13261999).withGrassColor(-13261999)
						.setAmbientSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("strangerthin:upisdeambiance")))
						.build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(UpsidedownforestdirtBlock.block.getDefaultState(),
								UpsidedirtforestBlock.block.getDefaultState(), UpsidedirtforestBlock.block.getDefaultState())));
